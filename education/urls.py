...
urlpatterns = [
    ...
    path('room_type_list/', views.get_room_type, name='room_type_list'),
    path('create_room_type/', views.create_room_type, name='create_room_type'),
    path('read_room_type/<int:pk>/', views.read_room_type, name='read_room_type'),
    path('update_room_type/<int:pk>/', views.update_room_type, name='update_room_type'),
    path('delete_room_type/<int:pk>/', views.delete_room_type, name='delete_room_type'),
